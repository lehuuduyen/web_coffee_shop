...
class DatabaseUpgrader {
	 ...
	 * @var string
	 */
	public const OPTION = 'NTVCO_db_version';

	/**
	 * @var string
	 */
	public const PREVIOUS_OPTION = 'NTVCO_previous_db_version';
	...
	public function init() {
		...
		if ( version_compare( NTVCO_DB_VERSION, $version, '=' ) ) {
			return;
		}
	...
	protected function initial() {
		...
		$schema = <<<SQL
CREATE TABLE {$wpdb->prefix}NTVCO_data (
...
SQL;
	...
	protected function finish_up( $previous_version ) {
		...
		update_option( self::OPTION, NTVCO_DB_VERSION );
	}
}
