...
class AddressHooks {
	...
	public function setup_country_locale_fields( $locale ) {
		$locale['VN'] = array_merge(
			...
			[
				'state' => [
					'label' => esc_html__( 'Province', 'Ntvco' ),
					'placeholder' => __( 'Province', 'Ntvco' ),
					'required' => true,
					'hidden' => false,
					'priority' => 42,
				],
				'city' => [
					'label' => esc_html__( 'District', 'Ntvco' ),
					'placeholder' => esc_html__( 'District', 'Ntvco' ),
					'class' => [ 'address-field' ],
					'required' => true,
					'hidden' => false,
					'priority' => 44,
				...
				'address_2' => [
					'label' => esc_html__( 'Ward', 'Ntvco' ),
					'placeholder' => esc_html__( 'Ward', 'Ntvco' ),
					'class' => [ 'address-field' ],
					'required' => false,
					'hidden' => false,
					'priority' => 46,
