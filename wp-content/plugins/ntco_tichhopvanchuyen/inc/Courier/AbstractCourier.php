...
use Ntvco\Courier\Response\JsonResponseData;
...
abstract class AbstractCourier {
	...
	public function get_available_services( $parameters ) {
		throw new UnsupportedMethodException(
			sprintf(
				__( 'Lấy thông tin dịch vụ giao hàng không được hỗ trợ bởi %s.', 'Ntvco' ),
	...
	public function get_lead_time( $parameters ) {
		throw new UnsupportedMethodException(
			sprintf(
				__( 'Lấy thông tin ngày giao hàng không được hỗ trợ bởi %s.', 'Ntvco' ),
				( new ReflectionClass( $this ) )->getShortName()
			)
		);
	}
