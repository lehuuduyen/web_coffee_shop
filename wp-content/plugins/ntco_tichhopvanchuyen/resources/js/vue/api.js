...
export const InteractsWithAPI = {
  ...
  methods: {
    ...
    getOrderShippingInfo() {
      const path = addQueryArgs('Ntvco/ghn-aff/shipping/show', {
    ...
    createShippingOrder(courier, data) {
      const path = `/Ntvco/ghn-aff/shipping/${courier}/create`;
    ...
    cancelShippingOrder(data = {}) {
      const path = `/Ntvco/ghn-aff/shipping/${this.currentOrderId}/cancel`;
    ...
    getAvailableServices(courier, data) {
      const path = `/Ntvco/ghn-aff/shipping/${courier}/available-services`;
      data = { order_id: this.currentOrderId, ...data };
    ...
    getShippingFee(courier, data) {
      const path = `/Ntvco/ghn-aff/shipping/${courier}/fee`;
    ...
    getLeadTime(courier, data) {
      const path = `/Ntvco/ghn-aff/shipping/${courier}/lead-time`;
