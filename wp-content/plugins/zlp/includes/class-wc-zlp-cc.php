...
/**
 * WC_Gateway_ZaloPay_CC class.
 *
 * @extends WC_Payment_Gateway
 */
class WC_Gateway_ZaloPay_CC extends WC_Payment_Gateway
{
	public $appID;
	public $key1;
	public $key2;
	...
	public function __construct()
	{
		...
		$this->method_description = __('Cho phép khách hàng thanh toán Thẻ Credit Card (Visa/Master/JCB Card)', 'woocommerce-gateway-zalopay-atm');
		$this->supports           = array(
			'products',
            'refunds',
		);
		...
		// Load the settings.
		$this->init_settings();
		$this->title = __('ZaloPay Gateway (Visa/Master/JCB)', 'woocommerce-gateway-zalopay-atm');
