 ...
 */
class WC_Gateway_ZaloPay_VIETQR extends WC_Payment_Gateway
{
	public $appID;
	public $key1;
	public $key2;
	...
	{
		$this->id = 'zlp_vietqr';
		$this->icon = plugins_url('assets/images/logo-vietqr.png', dirname(__FILE__));
		$this->has_fields = false;
		$this->method_description = __('Cho phép khách hàng thanh toán qua ứng dụng ZaloPay, Zalo & hơn 40 ứng dụng ngân hàng tại Việt Nam.', 'woocommerce-gateway-zalopay-atm');
		$this->supports           = array(
			'products',
            'refunds',
		);
		...
		// Load the settings.
		$this->init_settings();
		$this->title = __('ZaloPay Gateway (Viet QR)', 'woocommerce-gateway-zalopay-vietqr');
