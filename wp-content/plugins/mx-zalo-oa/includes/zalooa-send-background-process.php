...
if (!class_exists('WP_Async_Request', false)) {
    include_once MX_ZALOOA_PLUGIN_DIR . '/includes/lib/wp-async-request.php';
}

if (!class_exists('WP_Background_Process', false)) {
    include_once MX_ZALOOA_PLUGIN_DIR . '/includes/lib/wp-background-process.php';
}
...
class ZaloOA_Send_Process extends WP_Background_Process {
    ...
    protected function task($tracking_id) {
        ...
        //sleep(20);
        //error_log('b');
        if (function_exists('mx_zalo_main') && $tracking_id) {
            mx_zalo_main()->send_by_tracking_id($tracking_id);
        }
        return false;
    }
