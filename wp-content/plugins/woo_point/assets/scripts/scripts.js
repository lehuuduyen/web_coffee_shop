...
function handleInputChange(modal) {
  if (modal) {
    ...
    handleChangeValue(minimumSpending, showMinimumSpendingFinal);
     ...
     /* Handle discount */
     const discount = modal.querySelectorAll('input[name="discount[]"]');
     const showMinimumDiscountFinal = modal.querySelectorAll('.show-discount-final');
     handleChangeValue(discount, showMinimumDiscountFinal);
